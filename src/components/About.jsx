...
const About = () => {
  ...
  return (
    <section id="about" ref={sectionRef} className="min-h-screen flex flex-col items-center justify-center py-10 md:py-24 px-3 sm:px-4 overflow-hidden relative bg-black">
      ...
      <div className="container mx-auto relative z-20">
        <div className="mb-8 md:mb-24 text-center">
          <div className="inline-block relative">
            <h2 className="text-3xl sm:text-5xl md:text-8xl font-black text-white tracking-tighter uppercase">
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center justify-center">
          ...
          <div ref={textRef} className="w-full lg:w-1/2">
            <div className="grid grid-cols-1 gap-6">
              {/* Profile Bio Card */}
              <div className="p-4 sm:p-6 md:p-8 rounded-[1.5rem] sm:rounded-[2.5rem] bg-white/5 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-all duration-500">
                <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-3 sm:mb-4">
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-blue-500/10 border border-blue-500/20 rounded-lg text-blue-400 text-[10px] sm:text-xs font-bold tracking-widest uppercase">Mobile Developer</span>
                  <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-purple-500/10 border border-purple-500/20 rounded-lg text-purple-400 text-[10px] sm:text-xs font-bold tracking-widest uppercase">Full-Stack Developer</span>
                </div>
                <p className="text-sm sm:text-base md:text-2xl text-white/90 leading-relaxed font-light">
              ...
              {/* Education Timeline */}
              <div className="p-4 sm:p-6 md:p-8 rounded-[1.5rem] sm:rounded-[2.5rem] bg-white/5 border border-white/10 backdrop-blur-md relative overflow-hidden group">
                <div className="flex items-center mb-5 sm:mb-8">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl bg-blue-500/20 flex items-center justify-center mr-3 sm:mr-4">
                    <span className="text-base sm:text-xl">🎓</span>
                  </div>
                  <h3 className="text-lg sm:text-2xl font-bold text-white uppercase tracking-tight">Academic Journey</h3>
                </div>
                ...
                <div className="space-y-8 relative">
                  ...
                  <div className="relative pl-7 sm:pl-10">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between items-start mb-1">
                      <h4 className="text-sm sm:text-lg font-bold text-white">B.Tech Information Technology</h4>
                  ...
                  {/* HSC */}
                  <div className="relative pl-7 sm:pl-10 opacity-70 group-hover:opacity-100 transition-opacity">
                    <div className="absolute left-[3px] top-1.5 w-2 h-2 rounded-full bg-indigo-500"></div>
                    <div className="flex flex-col sm:flex-row sm:justify-between items-start mb-1">
                      <h4 className="text-sm sm:text-lg font-bold text-white">HSC</h4>
                  ...
                  <div className="relative pl-7 sm:pl-10 opacity-70 group-hover:opacity-100 transition-opacity">
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between items-start mb-1">
                      <h4 className="text-sm sm:text-lg font-bold text-white">SSLC</h4>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-4 mt-2">
                {['Mobile App Developer', 'Fullstack Developer', 'Cloud computing'].map(tag => (
                  <span key={tag} className="px-3 py-1.5 sm:px-6 sm:py-2 rounded-xl sm:rounded-2xl bg-white/5 border border-white/5 text-white/50 text-[10px] sm:text-xs font-bold tracking-wider sm:tracking-widest uppercase hover:border-blue-500/40 hover:text-blue-400 transition-all duration-300">
                    {tag}
                  </span>
                ))}
              </div>
